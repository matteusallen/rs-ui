...
module.exports = function(webpackEnv) {
  ...
  return {
    ...
    plugins: [
      new CopyPlugin([
        {
          from: paths.notificationsServiceWorker,
          to: `${paths.appBuild}/sw.js`
        }
      ]),
      new BundleAnalyzerPlugin({
        analyzerMode: 'disabled', // Set analyzerMode to 'static' to generate html report
        reportTitle: 'Open Stalls bundle analysis',
        reportFilename: 'bundle_report.html',
        openAnalyzer: false // If true, automatically open report in default browser.
      }),
